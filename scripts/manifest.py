...
def generate(filename, version):
    return {
        ...
        'targetAbi': '10.9.0.0',
        'sourceUrl': 'https://github.com/jasmineamber/jellyfin-plugin-metatube/releases/download/'
...
def main():
    ...
    with urlopen('https://raw.githubusercontent.com/jasmineamber/jellyfin-plugin-metatube/dist/manifest.json') as f:
